...
public class OutboundProcessingEventAspect extends PatientDiscoveryEventAspect {
    ...
    @Pointcut("execution(* gov.hhs.fha.nhinc.patientdiscovery.*.passthru.deferred.response.NhincProxyPatientDiscoveryAsyncRespImpl.proxyProcessPatientDiscoveryAsyncResp(..)) ||"
            + "execution(* gov.hhs.fha.nhinc.patientdiscovery._10.passthru.deferred.request.NhincProxyPatientDiscoveryDeferredRequestImpl.processPatientDiscoveryAsyncRequest*(..)) ||"
